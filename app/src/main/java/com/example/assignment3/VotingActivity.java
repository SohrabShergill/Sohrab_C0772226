        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(inputName.getText().toString().isEmpty()){
                    Toast.makeText(VotingActivity.this, "Name is missing", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(inputId.getText().toString().isEmpty()){
                    Toast.makeText(VotingActivity.this, "Id is missing", Toast.LENGTH_SHORT).show();
                    return;
                }

                for (Voter V : voters) {
                    if(V.getId() == Integer.parseInt(inputId.getText().toString())){
                        Toast.makeText(VotingActivity.this, "you already Voted", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                
                if(!toggleButton.isChecked()){
                    Toast.makeText(VotingActivity.this, "Check the terms & Condintiond", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(VotingActivity.this, "Thanks for Voting", Toast.LENGTH_SHORT).show();
